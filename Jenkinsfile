            ...
            steps{
                script{
                    ...
                    withSonarQubeEnv("SonarQ"){
                        sh "${mvnHome}/bin/mvn clean verify sonar:sonar -Dsonar.projectKey=TestUnitaire -Dsonar.projectName='TestUnitaire' -Dsonar.coverage.jacoco.xmlReportPaths=target/site/jacoco/jacoco.xml"
                    }
                }
            }
        }
